...
_PLATFORMS = [
    ...
    },
    {
        ...
        "setup_instructions": [
            ...
            "3. For AgentMail: create an inbox + API key at",
            "   https://console.agentmail.to and paste the API key as the password",
            "4. For other providers: use your email password or app-specific password",
            "5. IMAP must be enabled on your email account",
        ],
        "vars": [
            {"name": "EMAIL_ADDRESS", "prompt": "Email address", "password": False,
             "help": "The email address Hermes will use (e.g., hermes@gmail.com)."},
            {"name": "EMAIL_PASSWORD", "prompt": "Email password (or app password / API key)", "password": True,
             "help": "For Gmail, use an App Password (not your regular password). For AgentMail, use your API key."},
            {"name": "EMAIL_IMAP_HOST", "prompt": "IMAP host", "password": False,
             "help": "e.g., imap.gmail.com for Gmail, outlook.office365.com for Outlook, imap.agentmail.to for AgentMail."},
            {"name": "EMAIL_SMTP_HOST", "prompt": "SMTP host", "password": False,
             "help": "e.g., smtp.gmail.com for Gmail, smtp.office365.com for Outlook, smtp.agentmail.to for AgentMail."},
